<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('ctiquetes');?>"><i class="fa fa-dashboard"></i> Bodega</a></li>
    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="<?php base_url("cbodega") ?>" class="btn btn-success pull-right">
    ...
    <script>
        ...
        function closePrintView() {
            window.location.replace("<?php base_url('cbodega') ?>");
        }
    </script>