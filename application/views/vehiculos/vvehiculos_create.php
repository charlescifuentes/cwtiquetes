<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        <?php echo $title ?>
        <small>Registre un nuevo Vehículo</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open('cvehiculos/insert', 'class="form-horizontal"'); ?>
                        <div class="box-body">
                            <div class="form-group">
                                <label for="numero_vehiculo" class="col-sm-2 control-label">Número</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="numero_vehiculo">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="nombres_conductor">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="apellidos_conductor" class="col-sm-2 control-label">Apellidos Conductor</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="apellidos_conductor">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="telefono_conductor" class="col-sm-2 control-label">Teléfono Conductor</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="telefono_conductor">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="numero_licencia" class="col-sm-2 control-label">Número Licencia Transito</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="numero_licencia">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="categoria_licencia" class="col-sm-2 control-label">Categoría Licencia Transito</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="nombres_propietario">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="apellidos_propietario" class="col-sm-2 control-label">Apellidos Propietario</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="apellidos_propietario">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="telefono_propietario" class="col-sm-2 control-label">Teléfono Propietario</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="telefono_propietario">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
